<template>
    <section class="content">
        <router-link to="/orders/supply/new" class="btn btn-success btn-flat pull-right"><i class="fa fa-plus-circle fa-fw"></i>Create Supply Order</router-link>
        <h3 class="box-title">Supply Orders List</h3>
    ...
    -->
                    ...
                    <div class="box-body table-responsive no-padding">
                        <hb-tablepaged
                                :columns="columns"
                                apiUrl="/api/orders/supply"
                                editRoute="/orders/supply/"
