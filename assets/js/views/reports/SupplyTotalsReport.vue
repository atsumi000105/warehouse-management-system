<template>
    <section class="content">
        <div class="row">
            <h3 class="box-title col-lg-10">Supply Totals Report</h3>
        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box">
                    <hb-tablepaged
                        :columns="columns"
                        :sortOrder="[{ field: 's.id', direction: 'asc' }]"
                        :params="requestParams()"
                        ref="hbtable"
                        :perPage="50"
                        apiUrl="/api/reports/supplier-totals"
                    ></hb-tablepaged>
                    <!-- /.box-body -->
                </div>
                <!-- /.box -->
    ...
    export default {
        ...
        methods: {
            ...
            downloadExcel () {
                ...
                axios.get('/api/reports/supplier-totals', { params: params, responseType: 'blob' })
                    .then(response => {
