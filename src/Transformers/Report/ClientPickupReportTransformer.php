...
use App\Entity\User;
use App\Reports\ClientPickupRow;
...
use PHPStan\Rules\Methods\AbstractMethodInNonAbstractClassRule;

class ClientPickupReportTransformer extends TransformerAbstract
{
    protected $user;
